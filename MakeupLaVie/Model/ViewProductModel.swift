...
// MARK: - Welcome
struct ViewProductModel: Codable {
    let statusCode: Int
    let body: ViewProductBody
...
struct ViewProductBody : Codable, Identifiable {
    ...
    let tags: [JSONAny]?
    let similarProducts: [ViewProductBody]?
    let photos: [Photo]?
    let rating: Double
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case status, price, sale_price, stock
        ...
        case hasCompare, hasWishlist, hasCartItem, tags, similarProducts, photos
        case rating
    }
}
...
struct Photo: Codable {
    let thumbMain, thumbProfile, thumbIcon: String

    enum CodingKeys: String, CodingKey {
        case thumbMain = "thumb_main"
        case thumbProfile = "thumb_profile"
        case thumbIcon = "thumb_icon"
    }
}
