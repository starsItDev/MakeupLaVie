...
//            utilityFunctions.showAlertWithTitle(title: "", withMessage: "EmailAddress field is required!", withNavigation: self)
//            return
//        }
//        if (inputPassword?.text?.isEmpty)! {
//            utilityFunctions.showAlertWithTitle(title: "", withMessage: "The password field is required!", withNavigation: self)
//            return
//        }
