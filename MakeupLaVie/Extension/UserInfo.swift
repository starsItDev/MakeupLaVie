...
//  }
  ...
  var email : String {
    ...
    var phoneNo : String {
        get { return defaults.string(forKey: .strKeyUserDefaultsPhoneNo) ?? ""}
      set { defaults.set(newValue, forKey: .strKeyUserDefaultsPhoneNo)}
    }
//  var imageUrl : String {
...
//    }
    ...
    if let accessToken = array[5] as? String {
      ...
      if let phoneNo = array[9] as? String {
        shared.phoneNo = phoneNo
        //UserDefaults.standard.set(authToken, forKey: .strKeyUserDefaultstokenOfAuthentication)
      }
...
//    static let strKeyUserDefaultsUserName = "userName"
    ...
    static let strKeyUserDefaultsPhoneNo = "phoneNo"
